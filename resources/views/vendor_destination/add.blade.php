        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-md-8"><h4 class="page-title m-0">Add Vendor 2</h4></div>
                    <div class="col-md-4">
                        <div class="float-right d-none d-md-block">
                            <a class="btn btn-outline-primary waves-effect waves-light" href="<?php echo url('vendor-destination')?>" title="Back To Vendor 2 Lists"><i class="fas fa-arrow-left ml-1 mr-2"></i> Back To Vendor 2 Lists</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card m-b-30">
                <form class="" id="vendor_details" novalidate="novalidate" method="post">
                    ...
                    <div class="card-header">
                        <h4 class="mt-0 header-title">Vendor 2 Form</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="destination" name="destination" class="form-control first-capital" value="{{isset($data['destination']) ? $data['destination'] : ''}}" required />
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
    ...
    $( document ).ready(function() {
        ...
        $( "#vendor_details" ).validate({
            ...
            rules: {
                ...
                $.post('/speedex/vendor-destination/save', queryString, function (data) {
                    commonStatusMessage(data, '/speedex/vendor-destination');
                }, "JSON");
                return false;
            }
        })
