...
class CompanyDetail extends Model {
    ...
    protected $fillable = [
        'id', 'name',  'email_id', 'gst_no', 'contact_person', 'contact_person_mobile', 'address', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by'
    ];
    
	public function getSaveData() {
        return array('id', 'name', 'email_id', 'gst_no', 'contact_person', 'contact_person_mobile', 'address', 'status', 'created_at', 'created_by', 'updated_at', 'updated_by');
    }
    ...
    public function saveData($post) {
        ...
        if ($id == 0) {
            ...
            if ($this->getSingleData($id)) {
                ...
                $finalData->id = $id;
                $finalData->save();
                return array('id' => $id, 'status' => 'success', 'message' => "Company Data Updated.");
            }
            else {
                return false;
            }
